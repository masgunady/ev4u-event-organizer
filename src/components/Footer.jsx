		...
		<>
			<div className="w-[100%] flex flex-col md:flex-row justify-center md:justify-between gap-8 lg:gap-32 pt-11 mb-7">
				...
				<div className="flex flex-col gap-5 mt-2">
					<div className="text-base text-[#373a42] font-semibold tracking-[1px]">Wetick</div>
					<div>
			...
			<div className="md:self-start flex-1 my-7 text-base text-[#5a7184] font-semibold tracking-[1px]">&copy; 2020 Wetick All Rights Reserved</div>
		</>
	);
};
